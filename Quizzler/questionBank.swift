...
//  Quizzler
//
//  Created by Jeffrey Funk on 7/8/18.
...
class QuestionBank {
    ...
    // in a class this is called a property (constant of variable outside a class)
    var list = [Question]()

    // in a class this is called a method.
    init() {
        ...
        //list.append(Question(text: "This course is a great course on learning swift", correctAnswer: true))
